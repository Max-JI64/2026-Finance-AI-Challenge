"""Deterministic V4 application-preparation and confirmation contracts."""
...
NOTICE_EXTRACTION_CACHE_PATH = PROJECT_ROOT / "v4/runtime/notice_extraction_cache.sqlite"
...
def _load_complete_notice(request: NoticeExtractionRequest) -> tuple[list[Any], str]:
    ...
    chunks = search._load_candidates(  # V4 reads the existing local database without changing its shared contract.
