"""Independent FastAPI entry point for the V4 user experience."""
...
API_VERSION = "v4-api-v1.0"
STATIC_DIR = PROJECT_ROOT / "v4/static"
MAX_REQUEST_BYTES = 2 * 1024 * 1024

app = FastAPI(
    title="버팀AI V4 — 정책금융 행동 트윈",
    version=API_VERSION,
    description="필요한 질문과 금융 도구를 선택해 검증된 현금위기 대응 행동계획을 제공합니다.",
)
app.mount("/static", StaticFiles(directory=STATIC_DIR), name="v4-static")
