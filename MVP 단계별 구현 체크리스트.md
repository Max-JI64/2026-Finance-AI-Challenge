...
> 문서 상태: Stage 0~6·RE Stage 1~8.2 완료, Gate RE8.2 통과, RE Stage 9 대기
> 기준일: 2026-08-17
> 실행 체계: `Stage 0~6 + RE Stage 1~9`
> 기준 계획서: `프로젝트 계획서.md`
> 재설계 근거: `프로젝트 차별화 구상.md`
> 다음 실행 단계: Gate RE8.2 통과 결과를 기준으로 RE Stage 9 배포·최종 QA·제출 준비
...
- [ ] 승인 외부 전송 필드와 최대 30일 악용 모니터링 가능성 고지 확인
- [ ] 샘플 결과 재현
- [ ] 공식 링크 유효성
- [ ] 정책 접수기간·기준일
- [ ] 금융계산 재검산
...
- [ ] 현금부족·고부채·사후환급·자격 미확인·부적격·접수종료·지원 부족·Embedding 최대 2회 후 BM25 Fallback·오류 입력 포함
- [ ] 기존 정책 목록 화면과 13주 생존 시뮬레이션 화면에 동일 입력 적용
- [ ] Hybrid 후보 → 단계형 자격질문 → 검수 Event 동적 대안 → RE7 순위 Trace 보존
